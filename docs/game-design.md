...
| **3. Multiplayer**         | Crew codes, joining, live sync, rejoin, first-correct-answer-wins                                           | Firestore modeling, live listeners, transactions, anonymous auth |
...
| **5. Polish and playtest** | Animations, sound, awards, real playtest with 2+ phones                                                     | Framer Motion, Web Audio                                         |
