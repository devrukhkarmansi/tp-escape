...
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| Which puzzles split? | Coded message (message / cipher key, early and mid-game only), alien glyphs (inscription / symbol key; a split key is always complete, since its holder cannot see the word), Morse beacon (beacon / chart), gauges (two banks of dials), wiring panel (wires / repair manual), anomaly sweep (scope / fault report), and the finale's evidence cards (one card per player) | Only puzzles where each piece is useless alone. Late coded messages have no key to hand over, so they never split                      |
