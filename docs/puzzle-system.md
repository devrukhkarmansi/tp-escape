...
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| Which puzzles split? | Coded message (message / cipher key, early and mid-game only), alien glyphs (inscription / symbol key), Morse beacon (beacon / chart), gauges (two banks of dials), wiring panel (wires / repair manual). Coming next: split evidence for the finale (4D-3) | Only puzzles where each piece is useless alone. Late coded messages have no key to hand over, so they never split                      |
